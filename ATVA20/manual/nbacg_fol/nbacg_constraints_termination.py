...
locFDNO_0 = Int('locFDNO_0')
locFDNO_1 = Int('locFDNO_1')
locFDNO_2 = Int('locFDNO_2')
locFDNO_3 = Int('locFDNO_3')
locFDNO_4 = Int('locFDNO_4')
locFDNO_5 = Int('locFDNO_5')
locFDNO_6 = Int('locFDNO_6')
locFDNO_7 = Int('locFDNO_7')
locFDNO_8 = Int('locFDNO_8')
locFDNO_9 = Int('locFDNO_9')
s.add(locFDNO_0 >= 0)
s.add(locFDNO_1 >= 0)
s.add(locFDNO_2 >= 0)
s.add(locFDNO_3 >= 0)
...
locFDYES_0 = Int('locFDYES_0')
locFDYES_1 = Int('locFDYES_1')
locFDYES_2 = Int('locFDYES_2')
locFDYES_3 = Int('locFDYES_3')
locFDYES_4 = Int('locFDYES_4')
locFDYES_5 = Int('locFDYES_5')
locFDYES_6 = Int('locFDYES_6')
locFDYES_7 = Int('locFDYES_7')
locFDYES_8 = Int('locFDYES_8')
locFDYES_9 = Int('locFDYES_9')
s.add(locFDYES_0 >= 0)
s.add(locFDYES_1 >= 0)
s.add(locFDYES_2 >= 0)
s.add(locFDYES_3 >= 0)
...
s.add(locNO_0 + locYES_0 + locFDNO_0 + locFDYES_0 + locSE_0 + locCMT_0 + locABR_0 + locCR_0 == N)
s.add(locNO_1 + locYES_1 + locFDNO_1 + locFDYES_1 + locSE_1 + locCMT_1 + locABR_1 + locCR_1 == N)
s.add(locNO_2 + locYES_2 + locFDNO_2 + locFDYES_2 + locSE_2 + locCMT_2 + locABR_2 + locCR_2 == N)
s.add(locNO_3 + locYES_3 + locFDNO_3 + locFDYES_3 + locSE_3 + locCMT_3 + locABR_3 + locCR_3 == N)
s.add(locNO_4 + locYES_4 + locFDNO_4 + locFDYES_4 + locSE_4 + locCMT_4 + locABR_4 + locCR_4 == N)
s.add(locNO_5 + locYES_5 + locFDNO_5 + locFDYES_5 + locSE_5 + locCMT_5 + locABR_5 + locCR_5 == N)
s.add(locNO_6 + locYES_6 + locFDNO_6 + locFDYES_6 + locSE_6 + locCMT_6 + locABR_6 + locCR_6 == N)
s.add(locNO_7 + locYES_7 + locFDNO_7 + locFDYES_7 + locSE_7 + locCMT_7 + locABR_7 + locCR_7 == N)
s.add(locNO_8 + locYES_8 + locFDNO_8 + locFDYES_8 + locSE_8 + locCMT_8 + locABR_8 + locCR_8 == N)
s.add(locNO_9 + locYES_9 + locFDNO_9 + locFDYES_9 + locSE_9 + locCMT_9 + locABR_9 + locCR_9 == N)
...
s.add( - x1_0 - x8_0 ==  locYES_1 - locYES_0)
s.add( - x2_0 - x7_0 ==  locFDNO_1 - locFDNO_0)
s.add( - x3_0 - x9_0 ==  locFDYES_1 - locFDYES_0)
s.add( + x0_0 + x1_0 - x4_0 - x5_0 - x10_0 - x13_0 + x13_0 ==  locSE_1 - locSE_0)
s.add( + x5_0 - x11_0 - x14_0 + x14_0 ==  locCMT_1 - locCMT_0)
s.add( + x2_0 + x3_0 + x4_0 - x12_0 - x15_0 + x15_0 ==  locABR_1 - locABR_0)
s.add( + x6_0 + x7_0 + x8_0 + x9_0 + x10_0 + x11_0 + x12_0 ==  locCR_1 - locCR_0)
s.add( - x0_1 - x6_1 ==  locNO_2 - locNO_1)
s.add( - x1_1 - x8_1 ==  locYES_2 - locYES_1)
s.add( - x2_1 - x7_1 ==  locFDNO_2 - locFDNO_1)
s.add( - x3_1 - x9_1 ==  locFDYES_2 - locFDYES_1)
s.add( + x0_1 + x1_1 - x4_1 - x5_1 - x10_1 - x13_1 + x13_1 ==  locSE_2 - locSE_1)
s.add( + x5_1 - x11_1 - x14_1 + x14_1 ==  locCMT_2 - locCMT_1)
s.add( + x2_1 + x3_1 + x4_1 - x12_1 - x15_1 + x15_1 ==  locABR_2 - locABR_1)
s.add( + x6_1 + x7_1 + x8_1 + x9_1 + x10_1 + x11_1 + x12_1 ==  locCR_2 - locCR_1)
s.add( - x0_2 - x6_2 ==  locNO_3 - locNO_2)
s.add( - x1_2 - x8_2 ==  locYES_3 - locYES_2)
s.add( - x2_2 - x7_2 ==  locFDNO_3 - locFDNO_2)
s.add( - x3_2 - x9_2 ==  locFDYES_3 - locFDYES_2)
s.add( + x0_2 + x1_2 - x4_2 - x5_2 - x10_2 - x13_2 + x13_2 ==  locSE_3 - locSE_2)
s.add( + x5_2 - x11_2 - x14_2 + x14_2 ==  locCMT_3 - locCMT_2)
s.add( + x2_2 + x3_2 + x4_2 - x12_2 - x15_2 + x15_2 ==  locABR_3 - locABR_2)
s.add( + x6_2 + x7_2 + x8_2 + x9_2 + x10_2 + x11_2 + x12_2 ==  locCR_3 - locCR_2)
s.add( - x0_3 - x6_3 ==  locNO_4 - locNO_3)
s.add( - x1_3 - x8_3 ==  locYES_4 - locYES_3)
s.add( - x2_3 - x7_3 ==  locFDNO_4 - locFDNO_3)
s.add( - x3_3 - x9_3 ==  locFDYES_4 - locFDYES_3)
s.add( + x0_3 + x1_3 - x4_3 - x5_3 - x10_3 - x13_3 + x13_3 ==  locSE_4 - locSE_3)
s.add( + x5_3 - x11_3 - x14_3 + x14_3 ==  locCMT_4 - locCMT_3)
s.add( + x2_3 + x3_3 + x4_3 - x12_3 - x15_3 + x15_3 ==  locABR_4 - locABR_3)
s.add( + x6_3 + x7_3 + x8_3 + x9_3 + x10_3 + x11_3 + x12_3 ==  locCR_4 - locCR_3)
s.add( - x0_4 - x6_4 ==  locNO_5 - locNO_4)
s.add( - x1_4 - x8_4 ==  locYES_5 - locYES_4)
s.add( - x2_4 - x7_4 ==  locFDNO_5 - locFDNO_4)
s.add( - x3_4 - x9_4 ==  locFDYES_5 - locFDYES_4)
s.add( + x0_4 + x1_4 - x4_4 - x5_4 - x10_4 - x13_4 + x13_4 ==  locSE_5 - locSE_4)
s.add( + x5_4 - x11_4 - x14_4 + x14_4 ==  locCMT_5 - locCMT_4)
s.add( + x2_4 + x3_4 + x4_4 - x12_4 - x15_4 + x15_4 ==  locABR_5 - locABR_4)
s.add( + x6_4 + x7_4 + x8_4 + x9_4 + x10_4 + x11_4 + x12_4 ==  locCR_5 - locCR_4)
s.add( - x0_5 - x6_5 ==  locNO_6 - locNO_5)
s.add( - x1_5 - x8_5 ==  locYES_6 - locYES_5)
s.add( - x2_5 - x7_5 ==  locFDNO_6 - locFDNO_5)
s.add( - x3_5 - x9_5 ==  locFDYES_6 - locFDYES_5)
s.add( + x0_5 + x1_5 - x4_5 - x5_5 - x10_5 - x13_5 + x13_5 ==  locSE_6 - locSE_5)
s.add( + x5_5 - x11_5 - x14_5 + x14_5 ==  locCMT_6 - locCMT_5)
s.add( + x2_5 + x3_5 + x4_5 - x12_5 - x15_5 + x15_5 ==  locABR_6 - locABR_5)
s.add( + x6_5 + x7_5 + x8_5 + x9_5 + x10_5 + x11_5 + x12_5 ==  locCR_6 - locCR_5)
s.add( - x0_6 - x6_6 ==  locNO_7 - locNO_6)
s.add( - x1_6 - x8_6 ==  locYES_7 - locYES_6)
s.add( - x2_6 - x7_6 ==  locFDNO_7 - locFDNO_6)
s.add( - x3_6 - x9_6 ==  locFDYES_7 - locFDYES_6)
s.add( + x0_6 + x1_6 - x4_6 - x5_6 - x10_6 - x13_6 + x13_6 ==  locSE_7 - locSE_6)
s.add( + x5_6 - x11_6 - x14_6 + x14_6 ==  locCMT_7 - locCMT_6)
s.add( + x2_6 + x3_6 + x4_6 - x12_6 - x15_6 + x15_6 ==  locABR_7 - locABR_6)
s.add( + x6_6 + x7_6 + x8_6 + x9_6 + x10_6 + x11_6 + x12_6 ==  locCR_7 - locCR_6)
s.add( - x0_7 - x6_7 ==  locNO_8 - locNO_7)
s.add( - x1_7 - x8_7 ==  locYES_8 - locYES_7)
s.add( - x2_7 - x7_7 ==  locFDNO_8 - locFDNO_7)
s.add( - x3_7 - x9_7 ==  locFDYES_8 - locFDYES_7)
s.add( + x0_7 + x1_7 - x4_7 - x5_7 - x10_7 - x13_7 + x13_7 ==  locSE_8 - locSE_7)
s.add( + x5_7 - x11_7 - x14_7 + x14_7 ==  locCMT_8 - locCMT_7)
s.add( + x2_7 + x3_7 + x4_7 - x12_7 - x15_7 + x15_7 ==  locABR_8 - locABR_7)
s.add( + x6_7 + x7_7 + x8_7 + x9_7 + x10_7 + x11_7 + x12_7 ==  locCR_8 - locCR_7)
s.add( - x0_8 - x6_8 ==  locNO_9 - locNO_8)
s.add( - x1_8 - x8_8 ==  locYES_9 - locYES_8)
s.add( - x2_8 - x7_8 ==  locFDNO_9 - locFDNO_8)
s.add( - x3_8 - x9_8 ==  locFDYES_9 - locFDYES_8)
s.add( + x0_8 + x1_8 - x4_8 - x5_8 - x10_8 - x13_8 + x13_8 ==  locSE_9 - locSE_8)
s.add( + x5_8 - x11_8 - x14_8 + x14_8 ==  locCMT_9 - locCMT_8)
s.add( + x2_8 + x3_8 + x4_8 - x12_8 - x15_8 + x15_8 ==  locABR_9 - locABR_8)
s.add( + x6_8 + x7_8 + x8_8 + x9_8 + x10_8 + x11_8 + x12_8 ==  locCR_9 - locCR_8)
...
s.add(Implies( (x4_0 > 0), ((nsntNoCF_0 >= 1) ) ))
s.add(Implies( (x4_1 > 0), ((nsntNoCF_1 >= 1) ) ))
s.add(Implies( (x4_2 > 0), ((nsntNoCF_2 >= 1) ) ))
s.add(Implies( (x4_3 > 0), ((nsntNoCF_3 >= 1) ) ))
s.add(Implies( (x4_4 > 0), ((nsntNoCF_4 >= 1) ) ))
s.add(Implies( (x4_5 > 0), ((nsntNoCF_5 >= 1) ) ))
s.add(Implies( (x4_6 > 0), ((nsntNoCF_6 >= 1) ) ))
s.add(Implies( (x4_7 > 0), ((nsntNoCF_7 >= 1) ) ))
s.add(Implies( (x4_8 > 0), ((nsntNoCF_8 >= 1) ) ))
...
s.add(And(locFDNO_0 == 0, locFDYES_0 == 0) )
...
s.add((locNO_0 + locYES_0 + locFDNO_0 + locFDYES_0) == N)
s.add(locSE_0 == 0)
s.add(locCMT_0 == 0)
s.add(locABR_0 == 0)
s.add(locCR_0 == 0)
...
s.add(And(And(locCR_0 == 0, x6_0 == 0, x7_0 == 0, x8_0 == 0, x9_0 == 0, x10_0 == 0, x11_0 == 0, x12_0 == 0, ), Or(locNO_0 != 0, locFDNO_0 != 0, locYES_0 != 0, locFDYES_0 != 0, locCR_0 != 0)) )
s.add(And(And(locCR_1 == 0, x6_1 == 0, x7_1 == 0, x8_1 == 0, x9_1 == 0, x10_1 == 0, x11_1 == 0, x12_1 == 0, ), Or(locNO_1 != 0, locFDNO_1 != 0, locYES_1 != 0, locFDYES_1 != 0, locCR_1 != 0)) )
s.add(And(And(locCR_2 == 0, x6_2 == 0, x7_2 == 0, x8_2 == 0, x9_2 == 0, x10_2 == 0, x11_2 == 0, x12_2 == 0, ), Or(locNO_2 != 0, locFDNO_2 != 0, locYES_2 != 0, locFDYES_2 != 0, locCR_2 != 0)) )
s.add(And(And(locCR_3 == 0, x6_3 == 0, x7_3 == 0, x8_3 == 0, x9_3 == 0, x10_3 == 0, x11_3 == 0, x12_3 == 0, ), Or(locNO_3 != 0, locFDNO_3 != 0, locYES_3 != 0, locFDYES_3 != 0, locCR_3 != 0)) )
s.add(And(And(locCR_4 == 0, x6_4 == 0, x7_4 == 0, x8_4 == 0, x9_4 == 0, x10_4 == 0, x11_4 == 0, x12_4 == 0, ), Or(locNO_4 != 0, locFDNO_4 != 0, locYES_4 != 0, locFDYES_4 != 0, locCR_4 != 0)) )
s.add(And(And(locCR_5 == 0, x6_5 == 0, x7_5 == 0, x8_5 == 0, x9_5 == 0, x10_5 == 0, x11_5 == 0, x12_5 == 0, ), Or(locNO_5 != 0, locFDNO_5 != 0, locYES_5 != 0, locFDYES_5 != 0, locCR_5 != 0)) )
s.add(And(And(locCR_6 == 0, x6_6 == 0, x7_6 == 0, x8_6 == 0, x9_6 == 0, x10_6 == 0, x11_6 == 0, x12_6 == 0, ), Or(locNO_6 != 0, locFDNO_6 != 0, locYES_6 != 0, locFDYES_6 != 0, locCR_6 != 0)) )
s.add(And(And(locCR_7 == 0, x6_7 == 0, x7_7 == 0, x8_7 == 0, x9_7 == 0, x10_7 == 0, x11_7 == 0, x12_7 == 0, ), Or(locNO_7 != 0, locFDNO_7 != 0, locYES_7 != 0, locFDYES_7 != 0, locCR_7 != 0)) )
s.add(And(And(locCR_8 == 0, x6_8 == 0, x7_8 == 0, x8_8 == 0, x9_8 == 0, x10_8 == 0, x11_8 == 0, x12_8 == 0, ), Or(locNO_8 != 0, locFDNO_8 != 0, locYES_8 != 0, locFDYES_8 != 0, locCR_8 != 0)) )
s.add(And(locCR_9 == 0, Or(locNO_9 != 0, locFDNO_9 != 0, locYES_9 != 0, locFDYES_9 != 0, locCR_9 != 0)) )
...
locFDNO_10 = Int('locFDNO_10')
locFDNO_11 = Int('locFDNO_11')
locFDNO_12 = Int('locFDNO_12')
locFDNO_13 = Int('locFDNO_13')
locFDNO_14 = Int('locFDNO_14')
locFDNO_15 = Int('locFDNO_15')
locFDNO_16 = Int('locFDNO_16')
locFDNO_17 = Int('locFDNO_17')
locFDNO_18 = Int('locFDNO_18')
s.add(locFDNO_10 >= 0)
s.add(locFDNO_11 >= 0)
s.add(locFDNO_12 >= 0)
s.add(locFDNO_13 >= 0)
...
locFDYES_10 = Int('locFDYES_10')
locFDYES_11 = Int('locFDYES_11')
locFDYES_12 = Int('locFDYES_12')
locFDYES_13 = Int('locFDYES_13')
locFDYES_14 = Int('locFDYES_14')
locFDYES_15 = Int('locFDYES_15')
locFDYES_16 = Int('locFDYES_16')
locFDYES_17 = Int('locFDYES_17')
locFDYES_18 = Int('locFDYES_18')
s.add(locFDYES_10 >= 0)
s.add(locFDYES_11 >= 0)
s.add(locFDYES_12 >= 0)
s.add(locFDYES_13 >= 0)
...
s.add(locNO_10 + locYES_10 + locFDNO_10 + locFDYES_10 + locSE_10 + locCMT_10 + locABR_10 + locCR_10 == N)
s.add(locNO_11 + locYES_11 + locFDNO_11 + locFDYES_11 + locSE_11 + locCMT_11 + locABR_11 + locCR_11 == N)
s.add(locNO_12 + locYES_12 + locFDNO_12 + locFDYES_12 + locSE_12 + locCMT_12 + locABR_12 + locCR_12 == N)
s.add(locNO_13 + locYES_13 + locFDNO_13 + locFDYES_13 + locSE_13 + locCMT_13 + locABR_13 + locCR_13 == N)
s.add(locNO_14 + locYES_14 + locFDNO_14 + locFDYES_14 + locSE_14 + locCMT_14 + locABR_14 + locCR_14 == N)
s.add(locNO_15 + locYES_15 + locFDNO_15 + locFDYES_15 + locSE_15 + locCMT_15 + locABR_15 + locCR_15 == N)
s.add(locNO_16 + locYES_16 + locFDNO_16 + locFDYES_16 + locSE_16 + locCMT_16 + locABR_16 + locCR_16 == N)
s.add(locNO_17 + locYES_17 + locFDNO_17 + locFDYES_17 + locSE_17 + locCMT_17 + locABR_17 + locCR_17 == N)
s.add(locNO_18 + locYES_18 + locFDNO_18 + locFDYES_18 + locSE_18 + locCMT_18 + locABR_18 + locCR_18 == N)
...
s.add( - x1_9 - x8_9 ==  locYES_10 - locYES_9)
s.add( - x2_9 - x7_9 ==  locFDNO_10 - locFDNO_9)
s.add( - x3_9 - x9_9 ==  locFDYES_10 - locFDYES_9)
s.add( + x0_9 + x1_9 - x4_9 - x5_9 - x10_9 - x13_9 + x13_9 ==  locSE_10 - locSE_9)
s.add( + x5_9 - x11_9 - x14_9 + x14_9 ==  locCMT_10 - locCMT_9)
s.add( + x2_9 + x3_9 + x4_9 - x12_9 - x15_9 + x15_9 ==  locABR_10 - locABR_9)
s.add( + x6_9 + x7_9 + x8_9 + x9_9 + x10_9 + x11_9 + x12_9 ==  locCR_10 - locCR_9)
s.add( - x0_10 - x6_10 ==  locNO_11 - locNO_10)
s.add( - x1_10 - x8_10 ==  locYES_11 - locYES_10)
s.add( - x2_10 - x7_10 ==  locFDNO_11 - locFDNO_10)
s.add( - x3_10 - x9_10 ==  locFDYES_11 - locFDYES_10)
s.add( + x0_10 + x1_10 - x4_10 - x5_10 - x10_10 - x13_10 + x13_10 ==  locSE_11 - locSE_10)
s.add( + x5_10 - x11_10 - x14_10 + x14_10 ==  locCMT_11 - locCMT_10)
s.add( + x2_10 + x3_10 + x4_10 - x12_10 - x15_10 + x15_10 ==  locABR_11 - locABR_10)
s.add( + x6_10 + x7_10 + x8_10 + x9_10 + x10_10 + x11_10 + x12_10 ==  locCR_11 - locCR_10)
s.add( - x0_11 - x6_11 ==  locNO_12 - locNO_11)
s.add( - x1_11 - x8_11 ==  locYES_12 - locYES_11)
s.add( - x2_11 - x7_11 ==  locFDNO_12 - locFDNO_11)
s.add( - x3_11 - x9_11 ==  locFDYES_12 - locFDYES_11)
s.add( + x0_11 + x1_11 - x4_11 - x5_11 - x10_11 - x13_11 + x13_11 ==  locSE_12 - locSE_11)
s.add( + x5_11 - x11_11 - x14_11 + x14_11 ==  locCMT_12 - locCMT_11)
s.add( + x2_11 + x3_11 + x4_11 - x12_11 - x15_11 + x15_11 ==  locABR_12 - locABR_11)
s.add( + x6_11 + x7_11 + x8_11 + x9_11 + x10_11 + x11_11 + x12_11 ==  locCR_12 - locCR_11)
s.add( - x0_12 - x6_12 ==  locNO_13 - locNO_12)
s.add( - x1_12 - x8_12 ==  locYES_13 - locYES_12)
s.add( - x2_12 - x7_12 ==  locFDNO_13 - locFDNO_12)
s.add( - x3_12 - x9_12 ==  locFDYES_13 - locFDYES_12)
s.add( + x0_12 + x1_12 - x4_12 - x5_12 - x10_12 - x13_12 + x13_12 ==  locSE_13 - locSE_12)
s.add( + x5_12 - x11_12 - x14_12 + x14_12 ==  locCMT_13 - locCMT_12)
s.add( + x2_12 + x3_12 + x4_12 - x12_12 - x15_12 + x15_12 ==  locABR_13 - locABR_12)
s.add( + x6_12 + x7_12 + x8_12 + x9_12 + x10_12 + x11_12 + x12_12 ==  locCR_13 - locCR_12)
s.add( - x0_13 - x6_13 ==  locNO_14 - locNO_13)
s.add( - x1_13 - x8_13 ==  locYES_14 - locYES_13)
s.add( - x2_13 - x7_13 ==  locFDNO_14 - locFDNO_13)
s.add( - x3_13 - x9_13 ==  locFDYES_14 - locFDYES_13)
s.add( + x0_13 + x1_13 - x4_13 - x5_13 - x10_13 - x13_13 + x13_13 ==  locSE_14 - locSE_13)
s.add( + x5_13 - x11_13 - x14_13 + x14_13 ==  locCMT_14 - locCMT_13)
s.add( + x2_13 + x3_13 + x4_13 - x12_13 - x15_13 + x15_13 ==  locABR_14 - locABR_13)
s.add( + x6_13 + x7_13 + x8_13 + x9_13 + x10_13 + x11_13 + x12_13 ==  locCR_14 - locCR_13)
s.add( - x0_14 - x6_14 ==  locNO_15 - locNO_14)
s.add( - x1_14 - x8_14 ==  locYES_15 - locYES_14)
s.add( - x2_14 - x7_14 ==  locFDNO_15 - locFDNO_14)
s.add( - x3_14 - x9_14 ==  locFDYES_15 - locFDYES_14)
s.add( + x0_14 + x1_14 - x4_14 - x5_14 - x10_14 - x13_14 + x13_14 ==  locSE_15 - locSE_14)
s.add( + x5_14 - x11_14 - x14_14 + x14_14 ==  locCMT_15 - locCMT_14)
s.add( + x2_14 + x3_14 + x4_14 - x12_14 - x15_14 + x15_14 ==  locABR_15 - locABR_14)
s.add( + x6_14 + x7_14 + x8_14 + x9_14 + x10_14 + x11_14 + x12_14 ==  locCR_15 - locCR_14)
s.add( - x0_15 - x6_15 ==  locNO_16 - locNO_15)
s.add( - x1_15 - x8_15 ==  locYES_16 - locYES_15)
s.add( - x2_15 - x7_15 ==  locFDNO_16 - locFDNO_15)
s.add( - x3_15 - x9_15 ==  locFDYES_16 - locFDYES_15)
s.add( + x0_15 + x1_15 - x4_15 - x5_15 - x10_15 - x13_15 + x13_15 ==  locSE_16 - locSE_15)
s.add( + x5_15 - x11_15 - x14_15 + x14_15 ==  locCMT_16 - locCMT_15)
s.add( + x2_15 + x3_15 + x4_15 - x12_15 - x15_15 + x15_15 ==  locABR_16 - locABR_15)
s.add( + x6_15 + x7_15 + x8_15 + x9_15 + x10_15 + x11_15 + x12_15 ==  locCR_16 - locCR_15)
s.add( - x0_16 - x6_16 ==  locNO_17 - locNO_16)
s.add( - x1_16 - x8_16 ==  locYES_17 - locYES_16)
s.add( - x2_16 - x7_16 ==  locFDNO_17 - locFDNO_16)
s.add( - x3_16 - x9_16 ==  locFDYES_17 - locFDYES_16)
s.add( + x0_16 + x1_16 - x4_16 - x5_16 - x10_16 - x13_16 + x13_16 ==  locSE_17 - locSE_16)
s.add( + x5_16 - x11_16 - x14_16 + x14_16 ==  locCMT_17 - locCMT_16)
s.add( + x2_16 + x3_16 + x4_16 - x12_16 - x15_16 + x15_16 ==  locABR_17 - locABR_16)
s.add( + x6_16 + x7_16 + x8_16 + x9_16 + x10_16 + x11_16 + x12_16 ==  locCR_17 - locCR_16)
s.add( - x0_17 - x6_17 ==  locNO_18 - locNO_17)
s.add( - x1_17 - x8_17 ==  locYES_18 - locYES_17)
s.add( - x2_17 - x7_17 ==  locFDNO_18 - locFDNO_17)
s.add( - x3_17 - x9_17 ==  locFDYES_18 - locFDYES_17)
s.add( + x0_17 + x1_17 - x4_17 - x5_17 - x10_17 - x13_17 + x13_17 ==  locSE_18 - locSE_17)
s.add( + x5_17 - x11_17 - x14_17 + x14_17 ==  locCMT_18 - locCMT_17)
s.add( + x2_17 + x3_17 + x4_17 - x12_17 - x15_17 + x15_17 ==  locABR_18 - locABR_17)
s.add( + x6_17 + x7_17 + x8_17 + x9_17 + x10_17 + x11_17 + x12_17 ==  locCR_18 - locCR_17)
...
s.add(Implies( (x4_9 > 0), ((nsntNoCF_9 >= 1) ) ))
s.add(Implies( (x4_10 > 0), ((nsntNoCF_10 >= 1) ) ))
s.add(Implies( (x4_11 > 0), ((nsntNoCF_11 >= 1) ) ))
s.add(Implies( (x4_12 > 0), ((nsntNoCF_12 >= 1) ) ))
s.add(Implies( (x4_13 > 0), ((nsntNoCF_13 >= 1) ) ))
s.add(Implies( (x4_14 > 0), ((nsntNoCF_14 >= 1) ) ))
s.add(Implies( (x4_15 > 0), ((nsntNoCF_15 >= 1) ) ))
s.add(Implies( (x4_16 > 0), ((nsntNoCF_16 >= 1) ) ))
s.add(Implies( (x4_17 > 0), ((nsntNoCF_17 >= 1) ) ))
...
s.add(And(And(locCR_9 == 0, x6_9 == 0, x7_9 == 0, x8_9 == 0, x9_9 == 0, x10_9 == 0, x11_9 == 0, x12_9 == 0, ), Or(locNO_9 != 0, locFDNO_9 != 0, locYES_9 != 0, locFDYES_9 != 0, locCR_9 != 0)) )
s.add(And(And(locCR_10 == 0, x6_10 == 0, x7_10 == 0, x8_10 == 0, x9_10 == 0, x10_10 == 0, x11_10 == 0, x12_10 == 0, ), Or(locNO_10 != 0, locFDNO_10 != 0, locYES_10 != 0, locFDYES_10 != 0, locCR_10 != 0)) )
s.add(And(And(locCR_11 == 0, x6_11 == 0, x7_11 == 0, x8_11 == 0, x9_11 == 0, x10_11 == 0, x11_11 == 0, x12_11 == 0, ), Or(locNO_11 != 0, locFDNO_11 != 0, locYES_11 != 0, locFDYES_11 != 0, locCR_11 != 0)) )
s.add(And(And(locCR_12 == 0, x6_12 == 0, x7_12 == 0, x8_12 == 0, x9_12 == 0, x10_12 == 0, x11_12 == 0, x12_12 == 0, ), Or(locNO_12 != 0, locFDNO_12 != 0, locYES_12 != 0, locFDYES_12 != 0, locCR_12 != 0)) )
s.add(And(And(locCR_13 == 0, x6_13 == 0, x7_13 == 0, x8_13 == 0, x9_13 == 0, x10_13 == 0, x11_13 == 0, x12_13 == 0, ), Or(locNO_13 != 0, locFDNO_13 != 0, locYES_13 != 0, locFDYES_13 != 0, locCR_13 != 0)) )
s.add(And(And(locCR_14 == 0, x6_14 == 0, x7_14 == 0, x8_14 == 0, x9_14 == 0, x10_14 == 0, x11_14 == 0, x12_14 == 0, ), Or(locNO_14 != 0, locFDNO_14 != 0, locYES_14 != 0, locFDYES_14 != 0, locCR_14 != 0)) )
s.add(And(And(locCR_15 == 0, x6_15 == 0, x7_15 == 0, x8_15 == 0, x9_15 == 0, x10_15 == 0, x11_15 == 0, x12_15 == 0, ), Or(locNO_15 != 0, locFDNO_15 != 0, locYES_15 != 0, locFDYES_15 != 0, locCR_15 != 0)) )
s.add(And(And(locCR_16 == 0, x6_16 == 0, x7_16 == 0, x8_16 == 0, x9_16 == 0, x10_16 == 0, x11_16 == 0, x12_16 == 0, ), Or(locNO_16 != 0, locFDNO_16 != 0, locYES_16 != 0, locFDYES_16 != 0, locCR_16 != 0)) )
s.add(And(And(locCR_17 == 0, x6_17 == 0, x7_17 == 0, x8_17 == 0, x9_17 == 0, x10_17 == 0, x11_17 == 0, x12_17 == 0, ), Or(locNO_17 != 0, locFDNO_17 != 0, locYES_17 != 0, locFDYES_17 != 0, locCR_17 != 0)) )
s.add(And(locCR_18 == 0, Or(locNO_18 != 0, locFDNO_18 != 0, locYES_18 != 0, locFDYES_18 != 0, locCR_18 != 0)) )
s.add(And(And(locNO_9 == 0, ), And(locFDNO_9 == 0, ), And(locYES_9 == 0, ), And(locFDYES_9 == 0, ), Or(nsntNoCF_9 < 1, And(locSE_9 == 0, x0_9 == 0, x1_9 == 0, x13_9 == 0, )), Or(nsntYesCF_9 < N, nsntNoCF_9 >= 1, And(locSE_9 == 0, x0_9 == 0, x1_9 == 0, x13_9 == 0, ))) )
s.add(And(And(locNO_10 == 0, ), And(locFDNO_10 == 0, ), And(locYES_10 == 0, ), And(locFDYES_10 == 0, ), Or(nsntNoCF_10 < 1, And(locSE_10 == 0, x0_10 == 0, x1_10 == 0, x13_10 == 0, )), Or(nsntYesCF_10 < N, nsntNoCF_10 >= 1, And(locSE_10 == 0, x0_10 == 0, x1_10 == 0, x13_10 == 0, ))) )
s.add(And(And(locNO_11 == 0, ), And(locFDNO_11 == 0, ), And(locYES_11 == 0, ), And(locFDYES_11 == 0, ), Or(nsntNoCF_11 < 1, And(locSE_11 == 0, x0_11 == 0, x1_11 == 0, x13_11 == 0, )), Or(nsntYesCF_11 < N, nsntNoCF_11 >= 1, And(locSE_11 == 0, x0_11 == 0, x1_11 == 0, x13_11 == 0, ))) )
s.add(And(And(locNO_12 == 0, ), And(locFDNO_12 == 0, ), And(locYES_12 == 0, ), And(locFDYES_12 == 0, ), Or(nsntNoCF_12 < 1, And(locSE_12 == 0, x0_12 == 0, x1_12 == 0, x13_12 == 0, )), Or(nsntYesCF_12 < N, nsntNoCF_12 >= 1, And(locSE_12 == 0, x0_12 == 0, x1_12 == 0, x13_12 == 0, ))) )
s.add(And(And(locNO_13 == 0, ), And(locFDNO_13 == 0, ), And(locYES_13 == 0, ), And(locFDYES_13 == 0, ), Or(nsntNoCF_13 < 1, And(locSE_13 == 0, x0_13 == 0, x1_13 == 0, x13_13 == 0, )), Or(nsntYesCF_13 < N, nsntNoCF_13 >= 1, And(locSE_13 == 0, x0_13 == 0, x1_13 == 0, x13_13 == 0, ))) )
s.add(And(And(locNO_14 == 0, ), And(locFDNO_14 == 0, ), And(locYES_14 == 0, ), And(locFDYES_14 == 0, ), Or(nsntNoCF_14 < 1, And(locSE_14 == 0, x0_14 == 0, x1_14 == 0, x13_14 == 0, )), Or(nsntYesCF_14 < N, nsntNoCF_14 >= 1, And(locSE_14 == 0, x0_14 == 0, x1_14 == 0, x13_14 == 0, ))) )
s.add(And(And(locNO_15 == 0, ), And(locFDNO_15 == 0, ), And(locYES_15 == 0, ), And(locFDYES_15 == 0, ), Or(nsntNoCF_15 < 1, And(locSE_15 == 0, x0_15 == 0, x1_15 == 0, x13_15 == 0, )), Or(nsntYesCF_15 < N, nsntNoCF_15 >= 1, And(locSE_15 == 0, x0_15 == 0, x1_15 == 0, x13_15 == 0, ))) )
s.add(And(And(locNO_16 == 0, ), And(locFDNO_16 == 0, ), And(locYES_16 == 0, ), And(locFDYES_16 == 0, ), Or(nsntNoCF_16 < 1, And(locSE_16 == 0, x0_16 == 0, x1_16 == 0, x13_16 == 0, )), Or(nsntYesCF_16 < N, nsntNoCF_16 >= 1, And(locSE_16 == 0, x0_16 == 0, x1_16 == 0, x13_16 == 0, ))) )
s.add(And(And(locNO_17 == 0, ), And(locFDNO_17 == 0, ), And(locYES_17 == 0, ), And(locFDYES_17 == 0, ), Or(nsntNoCF_17 < 1, And(locSE_17 == 0, x0_17 == 0, x1_17 == 0, x13_17 == 0, )), Or(nsntYesCF_17 < N, nsntNoCF_17 >= 1, And(locSE_17 == 0, x0_17 == 0, x1_17 == 0, x13_17 == 0, ))) )
s.add(And(locNO_18 == 0, locFDNO_18 == 0, locYES_18 == 0, locFDYES_18 == 0, Or(nsntNoCF_18 < 1, locSE_18 == 0), Or(nsntYesCF_18 < N, nsntNoCF_18 >= 1, locSE_18 == 0)) )
...
locFDNO_19 = Int('locFDNO_19')
locFDNO_20 = Int('locFDNO_20')
locFDNO_21 = Int('locFDNO_21')
locFDNO_22 = Int('locFDNO_22')
locFDNO_23 = Int('locFDNO_23')
locFDNO_24 = Int('locFDNO_24')
locFDNO_25 = Int('locFDNO_25')
locFDNO_26 = Int('locFDNO_26')
locFDNO_27 = Int('locFDNO_27')
s.add(locFDNO_19 >= 0)
s.add(locFDNO_20 >= 0)
s.add(locFDNO_21 >= 0)
s.add(locFDNO_22 >= 0)
...
locFDYES_19 = Int('locFDYES_19')
locFDYES_20 = Int('locFDYES_20')
locFDYES_21 = Int('locFDYES_21')
locFDYES_22 = Int('locFDYES_22')
locFDYES_23 = Int('locFDYES_23')
locFDYES_24 = Int('locFDYES_24')
locFDYES_25 = Int('locFDYES_25')
locFDYES_26 = Int('locFDYES_26')
locFDYES_27 = Int('locFDYES_27')
s.add(locFDYES_19 >= 0)
s.add(locFDYES_20 >= 0)
s.add(locFDYES_21 >= 0)
s.add(locFDYES_22 >= 0)
...
s.add(locNO_19 + locYES_19 + locFDNO_19 + locFDYES_19 + locSE_19 + locCMT_19 + locABR_19 + locCR_19 == N)
s.add(locNO_20 + locYES_20 + locFDNO_20 + locFDYES_20 + locSE_20 + locCMT_20 + locABR_20 + locCR_20 == N)
s.add(locNO_21 + locYES_21 + locFDNO_21 + locFDYES_21 + locSE_21 + locCMT_21 + locABR_21 + locCR_21 == N)
s.add(locNO_22 + locYES_22 + locFDNO_22 + locFDYES_22 + locSE_22 + locCMT_22 + locABR_22 + locCR_22 == N)
s.add(locNO_23 + locYES_23 + locFDNO_23 + locFDYES_23 + locSE_23 + locCMT_23 + locABR_23 + locCR_23 == N)
s.add(locNO_24 + locYES_24 + locFDNO_24 + locFDYES_24 + locSE_24 + locCMT_24 + locABR_24 + locCR_24 == N)
s.add(locNO_25 + locYES_25 + locFDNO_25 + locFDYES_25 + locSE_25 + locCMT_25 + locABR_25 + locCR_25 == N)
s.add(locNO_26 + locYES_26 + locFDNO_26 + locFDYES_26 + locSE_26 + locCMT_26 + locABR_26 + locCR_26 == N)
s.add(locNO_27 + locYES_27 + locFDNO_27 + locFDYES_27 + locSE_27 + locCMT_27 + locABR_27 + locCR_27 == N)
...
s.add( - x1_18 - x8_18 ==  locYES_19 - locYES_18)
s.add( - x2_18 - x7_18 ==  locFDNO_19 - locFDNO_18)
s.add( - x3_18 - x9_18 ==  locFDYES_19 - locFDYES_18)
s.add( + x0_18 + x1_18 - x4_18 - x5_18 - x10_18 - x13_18 + x13_18 ==  locSE_19 - locSE_18)
s.add( + x5_18 - x11_18 - x14_18 + x14_18 ==  locCMT_19 - locCMT_18)
s.add( + x2_18 + x3_18 + x4_18 - x12_18 - x15_18 + x15_18 ==  locABR_19 - locABR_18)
s.add( + x6_18 + x7_18 + x8_18 + x9_18 + x10_18 + x11_18 + x12_18 ==  locCR_19 - locCR_18)
s.add( - x0_19 - x6_19 ==  locNO_20 - locNO_19)
s.add( - x1_19 - x8_19 ==  locYES_20 - locYES_19)
s.add( - x2_19 - x7_19 ==  locFDNO_20 - locFDNO_19)
s.add( - x3_19 - x9_19 ==  locFDYES_20 - locFDYES_19)
s.add( + x0_19 + x1_19 - x4_19 - x5_19 - x10_19 - x13_19 + x13_19 ==  locSE_20 - locSE_19)
s.add( + x5_19 - x11_19 - x14_19 + x14_19 ==  locCMT_20 - locCMT_19)
s.add( + x2_19 + x3_19 + x4_19 - x12_19 - x15_19 + x15_19 ==  locABR_20 - locABR_19)
s.add( + x6_19 + x7_19 + x8_19 + x9_19 + x10_19 + x11_19 + x12_19 ==  locCR_20 - locCR_19)
s.add( - x0_20 - x6_20 ==  locNO_21 - locNO_20)
s.add( - x1_20 - x8_20 ==  locYES_21 - locYES_20)
s.add( - x2_20 - x7_20 ==  locFDNO_21 - locFDNO_20)
s.add( - x3_20 - x9_20 ==  locFDYES_21 - locFDYES_20)
s.add( + x0_20 + x1_20 - x4_20 - x5_20 - x10_20 - x13_20 + x13_20 ==  locSE_21 - locSE_20)
s.add( + x5_20 - x11_20 - x14_20 + x14_20 ==  locCMT_21 - locCMT_20)
s.add( + x2_20 + x3_20 + x4_20 - x12_20 - x15_20 + x15_20 ==  locABR_21 - locABR_20)
s.add( + x6_20 + x7_20 + x8_20 + x9_20 + x10_20 + x11_20 + x12_20 ==  locCR_21 - locCR_20)
s.add( - x0_21 - x6_21 ==  locNO_22 - locNO_21)
s.add( - x1_21 - x8_21 ==  locYES_22 - locYES_21)
s.add( - x2_21 - x7_21 ==  locFDNO_22 - locFDNO_21)
s.add( - x3_21 - x9_21 ==  locFDYES_22 - locFDYES_21)
s.add( + x0_21 + x1_21 - x4_21 - x5_21 - x10_21 - x13_21 + x13_21 ==  locSE_22 - locSE_21)
s.add( + x5_21 - x11_21 - x14_21 + x14_21 ==  locCMT_22 - locCMT_21)
s.add( + x2_21 + x3_21 + x4_21 - x12_21 - x15_21 + x15_21 ==  locABR_22 - locABR_21)
s.add( + x6_21 + x7_21 + x8_21 + x9_21 + x10_21 + x11_21 + x12_21 ==  locCR_22 - locCR_21)
s.add( - x0_22 - x6_22 ==  locNO_23 - locNO_22)
s.add( - x1_22 - x8_22 ==  locYES_23 - locYES_22)
s.add( - x2_22 - x7_22 ==  locFDNO_23 - locFDNO_22)
s.add( - x3_22 - x9_22 ==  locFDYES_23 - locFDYES_22)
s.add( + x0_22 + x1_22 - x4_22 - x5_22 - x10_22 - x13_22 + x13_22 ==  locSE_23 - locSE_22)
s.add( + x5_22 - x11_22 - x14_22 + x14_22 ==  locCMT_23 - locCMT_22)
s.add( + x2_22 + x3_22 + x4_22 - x12_22 - x15_22 + x15_22 ==  locABR_23 - locABR_22)
s.add( + x6_22 + x7_22 + x8_22 + x9_22 + x10_22 + x11_22 + x12_22 ==  locCR_23 - locCR_22)
s.add( - x0_23 - x6_23 ==  locNO_24 - locNO_23)
s.add( - x1_23 - x8_23 ==  locYES_24 - locYES_23)
s.add( - x2_23 - x7_23 ==  locFDNO_24 - locFDNO_23)
s.add( - x3_23 - x9_23 ==  locFDYES_24 - locFDYES_23)
s.add( + x0_23 + x1_23 - x4_23 - x5_23 - x10_23 - x13_23 + x13_23 ==  locSE_24 - locSE_23)
s.add( + x5_23 - x11_23 - x14_23 + x14_23 ==  locCMT_24 - locCMT_23)
s.add( + x2_23 + x3_23 + x4_23 - x12_23 - x15_23 + x15_23 ==  locABR_24 - locABR_23)
s.add( + x6_23 + x7_23 + x8_23 + x9_23 + x10_23 + x11_23 + x12_23 ==  locCR_24 - locCR_23)
s.add( - x0_24 - x6_24 ==  locNO_25 - locNO_24)
s.add( - x1_24 - x8_24 ==  locYES_25 - locYES_24)
s.add( - x2_24 - x7_24 ==  locFDNO_25 - locFDNO_24)
s.add( - x3_24 - x9_24 ==  locFDYES_25 - locFDYES_24)
s.add( + x0_24 + x1_24 - x4_24 - x5_24 - x10_24 - x13_24 + x13_24 ==  locSE_25 - locSE_24)
s.add( + x5_24 - x11_24 - x14_24 + x14_24 ==  locCMT_25 - locCMT_24)
s.add( + x2_24 + x3_24 + x4_24 - x12_24 - x15_24 + x15_24 ==  locABR_25 - locABR_24)
s.add( + x6_24 + x7_24 + x8_24 + x9_24 + x10_24 + x11_24 + x12_24 ==  locCR_25 - locCR_24)
s.add( - x0_25 - x6_25 ==  locNO_26 - locNO_25)
s.add( - x1_25 - x8_25 ==  locYES_26 - locYES_25)
s.add( - x2_25 - x7_25 ==  locFDNO_26 - locFDNO_25)
s.add( - x3_25 - x9_25 ==  locFDYES_26 - locFDYES_25)
s.add( + x0_25 + x1_25 - x4_25 - x5_25 - x10_25 - x13_25 + x13_25 ==  locSE_26 - locSE_25)
s.add( + x5_25 - x11_25 - x14_25 + x14_25 ==  locCMT_26 - locCMT_25)
s.add( + x2_25 + x3_25 + x4_25 - x12_25 - x15_25 + x15_25 ==  locABR_26 - locABR_25)
s.add( + x6_25 + x7_25 + x8_25 + x9_25 + x10_25 + x11_25 + x12_25 ==  locCR_26 - locCR_25)
s.add( - x0_26 - x6_26 ==  locNO_27 - locNO_26)
s.add( - x1_26 - x8_26 ==  locYES_27 - locYES_26)
s.add( - x2_26 - x7_26 ==  locFDNO_27 - locFDNO_26)
s.add( - x3_26 - x9_26 ==  locFDYES_27 - locFDYES_26)
s.add( + x0_26 + x1_26 - x4_26 - x5_26 - x10_26 - x13_26 + x13_26 ==  locSE_27 - locSE_26)
s.add( + x5_26 - x11_26 - x14_26 + x14_26 ==  locCMT_27 - locCMT_26)
s.add( + x2_26 + x3_26 + x4_26 - x12_26 - x15_26 + x15_26 ==  locABR_27 - locABR_26)
s.add( + x6_26 + x7_26 + x8_26 + x9_26 + x10_26 + x11_26 + x12_26 ==  locCR_27 - locCR_26)
...
s.add(Implies( (x4_18 > 0), ((nsntNoCF_18 >= 1) ) ))
s.add(Implies( (x4_19 > 0), ((nsntNoCF_19 >= 1) ) ))
s.add(Implies( (x4_20 > 0), ((nsntNoCF_20 >= 1) ) ))
s.add(Implies( (x4_21 > 0), ((nsntNoCF_21 >= 1) ) ))
s.add(Implies( (x4_22 > 0), ((nsntNoCF_22 >= 1) ) ))
s.add(Implies( (x4_23 > 0), ((nsntNoCF_23 >= 1) ) ))
s.add(Implies( (x4_24 > 0), ((nsntNoCF_24 >= 1) ) ))
s.add(Implies( (x4_25 > 0), ((nsntNoCF_25 >= 1) ) ))
s.add(Implies( (x4_26 > 0), ((nsntNoCF_26 >= 1) ) ))
...
s.add(And(And(locCR_18 == 0, x6_18 == 0, x7_18 == 0, x8_18 == 0, x9_18 == 0, x10_18 == 0, x11_18 == 0, x12_18 == 0, ), Or(locNO_18 != 0, locFDNO_18 != 0, locYES_18 != 0, locFDYES_18 != 0, locCR_18 != 0)) )
s.add(And(And(locCR_19 == 0, x6_19 == 0, x7_19 == 0, x8_19 == 0, x9_19 == 0, x10_19 == 0, x11_19 == 0, x12_19 == 0, ), Or(locNO_19 != 0, locFDNO_19 != 0, locYES_19 != 0, locFDYES_19 != 0, locCR_19 != 0)) )
s.add(And(And(locCR_20 == 0, x6_20 == 0, x7_20 == 0, x8_20 == 0, x9_20 == 0, x10_20 == 0, x11_20 == 0, x12_20 == 0, ), Or(locNO_20 != 0, locFDNO_20 != 0, locYES_20 != 0, locFDYES_20 != 0, locCR_20 != 0)) )
s.add(And(And(locCR_21 == 0, x6_21 == 0, x7_21 == 0, x8_21 == 0, x9_21 == 0, x10_21 == 0, x11_21 == 0, x12_21 == 0, ), Or(locNO_21 != 0, locFDNO_21 != 0, locYES_21 != 0, locFDYES_21 != 0, locCR_21 != 0)) )
s.add(And(And(locCR_22 == 0, x6_22 == 0, x7_22 == 0, x8_22 == 0, x9_22 == 0, x10_22 == 0, x11_22 == 0, x12_22 == 0, ), Or(locNO_22 != 0, locFDNO_22 != 0, locYES_22 != 0, locFDYES_22 != 0, locCR_22 != 0)) )
s.add(And(And(locCR_23 == 0, x6_23 == 0, x7_23 == 0, x8_23 == 0, x9_23 == 0, x10_23 == 0, x11_23 == 0, x12_23 == 0, ), Or(locNO_23 != 0, locFDNO_23 != 0, locYES_23 != 0, locFDYES_23 != 0, locCR_23 != 0)) )
s.add(And(And(locCR_24 == 0, x6_24 == 0, x7_24 == 0, x8_24 == 0, x9_24 == 0, x10_24 == 0, x11_24 == 0, x12_24 == 0, ), Or(locNO_24 != 0, locFDNO_24 != 0, locYES_24 != 0, locFDYES_24 != 0, locCR_24 != 0)) )
s.add(And(And(locCR_25 == 0, x6_25 == 0, x7_25 == 0, x8_25 == 0, x9_25 == 0, x10_25 == 0, x11_25 == 0, x12_25 == 0, ), Or(locNO_25 != 0, locFDNO_25 != 0, locYES_25 != 0, locFDYES_25 != 0, locCR_25 != 0)) )
s.add(And(And(locCR_26 == 0, x6_26 == 0, x7_26 == 0, x8_26 == 0, x9_26 == 0, x10_26 == 0, x11_26 == 0, x12_26 == 0, ), Or(locNO_26 != 0, locFDNO_26 != 0, locYES_26 != 0, locFDYES_26 != 0, locCR_26 != 0)) )
s.add(And(locCR_27 == 0, Or(locNO_27 != 0, locFDNO_27 != 0, locYES_27 != 0, locFDYES_27 != 0, locCR_27 != 0)) )
s.add(And(And(locNO_18 == 0, ), And(locFDNO_18 == 0, ), And(locYES_18 == 0, ), And(locFDYES_18 == 0, ), Or(nsntNoCF_18 < 1, And(locSE_18 == 0, x0_18 == 0, x1_18 == 0, x13_18 == 0, )), Or(nsntYesCF_18 < N, nsntNoCF_18 >= 1, And(locSE_18 == 0, x0_18 == 0, x1_18 == 0, x13_18 == 0, ))) )
s.add(And(And(locNO_19 == 0, ), And(locFDNO_19 == 0, ), And(locYES_19 == 0, ), And(locFDYES_19 == 0, ), Or(nsntNoCF_19 < 1, And(locSE_19 == 0, x0_19 == 0, x1_19 == 0, x13_19 == 0, )), Or(nsntYesCF_19 < N, nsntNoCF_19 >= 1, And(locSE_19 == 0, x0_19 == 0, x1_19 == 0, x13_19 == 0, ))) )
s.add(And(And(locNO_20 == 0, ), And(locFDNO_20 == 0, ), And(locYES_20 == 0, ), And(locFDYES_20 == 0, ), Or(nsntNoCF_20 < 1, And(locSE_20 == 0, x0_20 == 0, x1_20 == 0, x13_20 == 0, )), Or(nsntYesCF_20 < N, nsntNoCF_20 >= 1, And(locSE_20 == 0, x0_20 == 0, x1_20 == 0, x13_20 == 0, ))) )
s.add(And(And(locNO_21 == 0, ), And(locFDNO_21 == 0, ), And(locYES_21 == 0, ), And(locFDYES_21 == 0, ), Or(nsntNoCF_21 < 1, And(locSE_21 == 0, x0_21 == 0, x1_21 == 0, x13_21 == 0, )), Or(nsntYesCF_21 < N, nsntNoCF_21 >= 1, And(locSE_21 == 0, x0_21 == 0, x1_21 == 0, x13_21 == 0, ))) )
s.add(And(And(locNO_22 == 0, ), And(locFDNO_22 == 0, ), And(locYES_22 == 0, ), And(locFDYES_22 == 0, ), Or(nsntNoCF_22 < 1, And(locSE_22 == 0, x0_22 == 0, x1_22 == 0, x13_22 == 0, )), Or(nsntYesCF_22 < N, nsntNoCF_22 >= 1, And(locSE_22 == 0, x0_22 == 0, x1_22 == 0, x13_22 == 0, ))) )
s.add(And(And(locNO_23 == 0, ), And(locFDNO_23 == 0, ), And(locYES_23 == 0, ), And(locFDYES_23 == 0, ), Or(nsntNoCF_23 < 1, And(locSE_23 == 0, x0_23 == 0, x1_23 == 0, x13_23 == 0, )), Or(nsntYesCF_23 < N, nsntNoCF_23 >= 1, And(locSE_23 == 0, x0_23 == 0, x1_23 == 0, x13_23 == 0, ))) )
s.add(And(And(locNO_24 == 0, ), And(locFDNO_24 == 0, ), And(locYES_24 == 0, ), And(locFDYES_24 == 0, ), Or(nsntNoCF_24 < 1, And(locSE_24 == 0, x0_24 == 0, x1_24 == 0, x13_24 == 0, )), Or(nsntYesCF_24 < N, nsntNoCF_24 >= 1, And(locSE_24 == 0, x0_24 == 0, x1_24 == 0, x13_24 == 0, ))) )
s.add(And(And(locNO_25 == 0, ), And(locFDNO_25 == 0, ), And(locYES_25 == 0, ), And(locFDYES_25 == 0, ), Or(nsntNoCF_25 < 1, And(locSE_25 == 0, x0_25 == 0, x1_25 == 0, x13_25 == 0, )), Or(nsntYesCF_25 < N, nsntNoCF_25 >= 1, And(locSE_25 == 0, x0_25 == 0, x1_25 == 0, x13_25 == 0, ))) )
s.add(And(And(locNO_26 == 0, ), And(locFDNO_26 == 0, ), And(locYES_26 == 0, ), And(locFDYES_26 == 0, ), Or(nsntNoCF_26 < 1, And(locSE_26 == 0, x0_26 == 0, x1_26 == 0, x13_26 == 0, )), Or(nsntYesCF_26 < N, nsntNoCF_26 >= 1, And(locSE_26 == 0, x0_26 == 0, x1_26 == 0, x13_26 == 0, ))) )
s.add(And(locNO_27 == 0, locFDNO_27 == 0, locYES_27 == 0, locFDYES_27 == 0, Or(nsntNoCF_27 < 1, locSE_27 == 0), Or(nsntYesCF_27 < N, nsntNoCF_27 >= 1, locSE_27 == 0)) )
s.add(True )
s.add(True )
s.add(True )
s.add(True )
...
s.add(Or(Or(x13_18 > 0, x14_18 > 0, x15_18 > 0), Or(x13_19 > 0, x14_19 > 0, x15_19 > 0), Or(x13_20 > 0, x14_20 > 0, x15_20 > 0), Or(x13_21 > 0, x14_21 > 0, x15_21 > 0), Or(x13_22 > 0, x14_22 > 0, x15_22 > 0), Or(x13_23 > 0, x14_23 > 0, x15_23 > 0), Or(x13_24 > 0, x14_24 > 0, x15_24 > 0), Or(x13_25 > 0, x14_25 > 0, x15_25 > 0), Or(x13_26 > 0, x14_26 > 0, x15_26 > 0)))
