...
specs['frb'] = ['_corr', '_relay', '_unforg']
specs['strb'] = ['_corr', '_relay', '_unforg']
specs['nbacg'] = ['_abort_validity', '_agreement', '_commit_validity', '_termination']
specs['nbacr'] = ['_nontriv', '_termination1', '_termination2', '_validity']
specs['aba'] = ['_agreement', '_corr', '_unforg']
specs['cbc'] = ['_validity0', '_validity1']
specs['cf1s'] = ['_onestep0', '_onestep1']
specs['c1cs'] = ['_onestep0', '_onestep1', '_fast0', '_fast1', '_termination']
specs['bosco'] = ['_onestep0', '_onestep1', '_fast0', '_fast1', '_lemma30', '_lemma31', '_lemma40', '_lemma41']


for base_file in specs:
