...
s.add(And(locAC_0 == 0, x4_0 == 0, x5_0 == 0, x8_0 == 0, ) )
s.add(And(locAC_1 == 0, x4_1 == 0, x5_1 == 0, x8_1 == 0, ) )
s.add(And(locAC_2 == 0, x4_2 == 0, x5_2 == 0, x8_2 == 0, ) )
s.add(And(locAC_3 == 0, x4_3 == 0, x5_3 == 0, x8_3 == 0, ) )
s.add(And(locAC_4 == 0, x4_4 == 0, x5_4 == 0, x8_4 == 0, ) )
s.add(And(locAC_5 == 0, x4_5 == 0, x5_5 == 0, x8_5 == 0, ) )
s.add(And(locAC_6 == 0, x4_6 == 0, x5_6 == 0, x8_6 == 0, ) )
s.add(locAC_7 == 0 )
...
s.add(And(locAC_7 == 0, x4_7 == 0, x5_7 == 0, x8_7 == 0, ) )
s.add(And(locAC_8 == 0, x4_8 == 0, x5_8 == 0, x8_8 == 0, ) )
s.add(And(locAC_9 == 0, x4_9 == 0, x5_9 == 0, x8_9 == 0, ) )
s.add(And(locAC_10 == 0, x4_10 == 0, x5_10 == 0, x8_10 == 0, ) )
s.add(And(locAC_11 == 0, x4_11 == 0, x5_11 == 0, x8_11 == 0, ) )
s.add(And(locAC_12 == 0, x4_12 == 0, x5_12 == 0, x8_12 == 0, ) )
s.add(And(locAC_13 == 0, x4_13 == 0, x5_13 == 0, x8_13 == 0, ) )
s.add(locAC_14 == 0 )
...
s.add(And(locAC_14 == 0, x4_14 == 0, x5_14 == 0, x8_14 == 0, ) )
s.add(And(locAC_15 == 0, x4_15 == 0, x5_15 == 0, x8_15 == 0, ) )
s.add(And(locAC_16 == 0, x4_16 == 0, x5_16 == 0, x8_16 == 0, ) )
s.add(And(locAC_17 == 0, x4_17 == 0, x5_17 == 0, x8_17 == 0, ) )
s.add(And(locAC_18 == 0, x4_18 == 0, x5_18 == 0, x8_18 == 0, ) )
s.add(And(locAC_19 == 0, x4_19 == 0, x5_19 == 0, x8_19 == 0, ) )
s.add(And(locAC_20 == 0, x4_20 == 0, x5_20 == 0, x8_20 == 0, ) )
s.add(locAC_21 == 0 )
...
s.add(Implies( (x8_14 > 0), (locAC_14 > 0)))
s.add(Implies( (x6_14 > 0), (loc0_14 > 0)))
s.add(Implies( (x7_14 > 0), (loc1_14 > 0)))
s.add(Implies( (x8_15 > 0), (locAC_15 > 0)))
s.add(Implies( (x6_15 > 0), (loc0_15 > 0)))
s.add(Implies( (x7_15 > 0), (loc1_15 > 0)))
s.add(Implies( (x8_16 > 0), (locAC_16 > 0)))
s.add(Implies( (x6_16 > 0), (loc0_16 > 0)))
s.add(Implies( (x7_16 > 0), (loc1_16 > 0)))
s.add(Implies( (x8_17 > 0), (locAC_17 > 0)))
s.add(Implies( (x6_17 > 0), (loc0_17 > 0)))
s.add(Implies( (x7_17 > 0), (loc1_17 > 0)))
s.add(Implies( (x8_18 > 0), (locAC_18 > 0)))
s.add(Implies( (x6_18 > 0), (loc0_18 > 0)))
s.add(Implies( (x7_18 > 0), (loc1_18 > 0)))
s.add(Implies( (x8_19 > 0), (locAC_19 > 0)))
s.add(Implies( (x6_19 > 0), (loc0_19 > 0)))
s.add(Implies( (x7_19 > 0), (loc1_19 > 0)))
s.add(Implies( (x8_20 > 0), (locAC_20 > 0)))
s.add(Implies( (x6_20 > 0), (loc0_20 > 0)))
s.add(Implies( (x7_20 > 0), (loc1_20 > 0)))

##################Closing the loop###############

s.add( loc0_14 == loc0_21 )
s.add( loc1_14 == loc1_21 )
s.add( locCR_14 == locCR_21 )
s.add( locAC_14 == locAC_21 )
s.add( nsnt_14 == nsnt_21 )
s.add( nsntF_14 == nsntF_21 )
s.add( nfaulty_14 == nfaulty_21 )

#################Ensuring that at least one rule has been fired

s.add(Or(Or(x6_14 > 0, x7_14 > 0, x8_14 > 0), Or(x6_15 > 0, x7_15 > 0, x8_15 > 0), Or(x6_16 > 0, x7_16 > 0, x8_16 > 0), Or(x6_17 > 0, x7_17 > 0, x8_17 > 0), Or(x6_18 > 0, x7_18 > 0, x8_18 > 0), Or(x6_19 > 0, x7_19 > 0, x8_19 > 0), Or(x6_20 > 0, x7_20 > 0, x8_20 > 0)))
