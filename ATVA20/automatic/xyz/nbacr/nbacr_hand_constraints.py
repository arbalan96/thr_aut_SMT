...
locSEFD_0 = Int('locSEFD_0')
locSEFD_1 = Int('locSEFD_1')
locSEFD_2 = Int('locSEFD_2')
locSEFD_3 = Int('locSEFD_3')
locSEFD_4 = Int('locSEFD_4')
locSEFD_5 = Int('locSEFD_5')
locSEFD_6 = Int('locSEFD_6')
locSEFD_7 = Int('locSEFD_7')
locSEFD_8 = Int('locSEFD_8')
locSEFD_9 = Int('locSEFD_9')
s.add(locSEFD_0 >= 0)
s.add(locSEFD_1 >= 0)
s.add(locSEFD_2 >= 0)
s.add(locSEFD_3 >= 0)
...
s.add(locNO_0 + locYES_0 + locSE_0 + locSEFD_0 + locCMT_0 + locABR_0 + locCR_0 == N)
s.add(locNO_1 + locYES_1 + locSE_1 + locSEFD_1 + locCMT_1 + locABR_1 + locCR_1 == N)
s.add(locNO_2 + locYES_2 + locSE_2 + locSEFD_2 + locCMT_2 + locABR_2 + locCR_2 == N)
s.add(locNO_3 + locYES_3 + locSE_3 + locSEFD_3 + locCMT_3 + locABR_3 + locCR_3 == N)
s.add(locNO_4 + locYES_4 + locSE_4 + locSEFD_4 + locCMT_4 + locABR_4 + locCR_4 == N)
s.add(locNO_5 + locYES_5 + locSE_5 + locSEFD_5 + locCMT_5 + locABR_5 + locCR_5 == N)
s.add(locNO_6 + locYES_6 + locSE_6 + locSEFD_6 + locCMT_6 + locABR_6 + locCR_6 == N)
s.add(locNO_7 + locYES_7 + locSE_7 + locSEFD_7 + locCMT_7 + locABR_7 + locCR_7 == N)
s.add(locNO_8 + locYES_8 + locSE_8 + locSEFD_8 + locCMT_8 + locABR_8 + locCR_8 == N)
s.add(locNO_9 + locYES_9 + locSE_9 + locSEFD_9 + locCMT_9 + locABR_9 + locCR_9 == N)
...
s.add( + x2_0 - x4_0 - x9_0 - x13_0 + x13_0 ==  locSEFD_1 - locSEFD_0)
...
s.add( + x2_1 - x4_1 - x9_1 - x13_1 + x13_1 ==  locSEFD_2 - locSEFD_1)
...
s.add( + x2_2 - x4_2 - x9_2 - x13_2 + x13_2 ==  locSEFD_3 - locSEFD_2)
...
s.add( + x2_3 - x4_3 - x9_3 - x13_3 + x13_3 ==  locSEFD_4 - locSEFD_3)
...
s.add( + x2_4 - x4_4 - x9_4 - x13_4 + x13_4 ==  locSEFD_5 - locSEFD_4)
...
s.add( + x2_5 - x4_5 - x9_5 - x13_5 + x13_5 ==  locSEFD_6 - locSEFD_5)
...
s.add( + x2_6 - x4_6 - x9_6 - x13_6 + x13_6 ==  locSEFD_7 - locSEFD_6)
...
s.add( + x2_7 - x4_7 - x9_7 - x13_7 + x13_7 ==  locSEFD_8 - locSEFD_7)
...
s.add( + x2_8 - x4_8 - x9_8 - x13_8 + x13_8 ==  locSEFD_9 - locSEFD_8)
