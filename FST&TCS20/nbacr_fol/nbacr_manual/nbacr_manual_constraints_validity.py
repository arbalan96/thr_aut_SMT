...
s.add(locSE_x0 >= 0)
s.add(locSE_y0 >= 0)
locFDSE_x0 = Real('locFDSE_x0')
locFDSE_y0 = Real('locFDSE_y0')
s.add(locFDSE_x0 >= 0)
s.add(locFDSE_y0 >= 0)
...
s.add(0 - rule1_x0 - rule7_x0 ==  locYES_y0 - locYES_x0)
s.add(0 + rule0_x0 + rule1_x0 - rule2_x0 - rule3_x0 - rule5_x0 - rule8_x0 - rule12_x0 + rule12_x0 ==  locSE_y0 - locSE_x0)
s.add(0 + rule2_x0 - rule4_x0 - rule9_x0 - rule13_x0 + rule13_x0 ==  locFDSE_y0 - locFDSE_x0)
s.add(0 + rule5_x0 - rule10_x0 - rule14_x0 + rule14_x0 ==  locCMT_y0 - locCMT_x0)
s.add(0 + rule3_x0 + rule4_x0 - rule11_x0 - rule15_x0 + rule15_x0 ==  locABR_y0 - locABR_x0)
s.add(0 + rule6_x0 + rule7_x0 + rule8_x0 + rule9_x0 + rule10_x0 + rule11_x0 ==  locCR_y0 - locCR_x0)
...
s.add(Implies( (rule3_x0 > 0), And(nsntNoCF_x0>=1, ) ))
...
s.add(And(locNO_x0 > 0, locNO_x0 > 0))
...
s.add(locSE_x1 >= 0)
s.add(locSE_y1 >= 0)
locFDSE_x1 = Real('locFDSE_x1')
locFDSE_y1 = Real('locFDSE_y1')
s.add(locFDSE_x1 >= 0)
s.add(locFDSE_y1 >= 0)
...
s.add(0 - rule1_x1 - rule7_x1 ==  locYES_y1 - locYES_x1)
s.add(0 + rule0_x1 + rule1_x1 - rule2_x1 - rule3_x1 - rule5_x1 - rule8_x1 - rule12_x1 + rule12_x1 ==  locSE_y1 - locSE_x1)
s.add(0 + rule2_x1 - rule4_x1 - rule9_x1 - rule13_x1 + rule13_x1 ==  locFDSE_y1 - locFDSE_x1)
s.add(0 + rule5_x1 - rule10_x1 - rule14_x1 + rule14_x1 ==  locCMT_y1 - locCMT_x1)
s.add(0 + rule3_x1 + rule4_x1 - rule11_x1 - rule15_x1 + rule15_x1 ==  locABR_y1 - locABR_x1)
s.add(0 + rule6_x1 + rule7_x1 + rule8_x1 + rule9_x1 + rule10_x1 + rule11_x1 ==  locCR_y1 - locCR_x1)
...
s.add(Implies( (rule3_x1 > 0), And(nsntNoCF_x1>=1, ) ))
...
s.add(locSE_x2 >= 0)
s.add(locSE_y2 >= 0)
locFDSE_x2 = Real('locFDSE_x2')
locFDSE_y2 = Real('locFDSE_y2')
s.add(locFDSE_x2 >= 0)
s.add(locFDSE_y2 >= 0)
...
s.add(0 - rule1_x2 - rule7_x2 ==  locYES_y2 - locYES_x2)
s.add(0 + rule0_x2 + rule1_x2 - rule2_x2 - rule3_x2 - rule5_x2 - rule8_x2 - rule12_x2 + rule12_x2 ==  locSE_y2 - locSE_x2)
s.add(0 + rule2_x2 - rule4_x2 - rule9_x2 - rule13_x2 + rule13_x2 ==  locFDSE_y2 - locFDSE_x2)
s.add(0 + rule5_x2 - rule10_x2 - rule14_x2 + rule14_x2 ==  locCMT_y2 - locCMT_x2)
s.add(0 + rule3_x2 + rule4_x2 - rule11_x2 - rule15_x2 + rule15_x2 ==  locABR_y2 - locABR_x2)
s.add(0 + rule6_x2 + rule7_x2 + rule8_x2 + rule9_x2 + rule10_x2 + rule11_x2 ==  locCR_y2 - locCR_x2)
...
s.add(Implies( (rule3_x2 > 0), And(nsntNoCF_x2>=1, ) ))
...
s.add(locSE_x3 >= 0)
s.add(locSE_y3 >= 0)
locFDSE_x3 = Real('locFDSE_x3')
locFDSE_y3 = Real('locFDSE_y3')
s.add(locFDSE_x3 >= 0)
s.add(locFDSE_y3 >= 0)
...
s.add(0 - rule1_x3 - rule7_x3 ==  locYES_y3 - locYES_x3)
s.add(0 + rule0_x3 + rule1_x3 - rule2_x3 - rule3_x3 - rule5_x3 - rule8_x3 - rule12_x3 + rule12_x3 ==  locSE_y3 - locSE_x3)
s.add(0 + rule2_x3 - rule4_x3 - rule9_x3 - rule13_x3 + rule13_x3 ==  locFDSE_y3 - locFDSE_x3)
s.add(0 + rule5_x3 - rule10_x3 - rule14_x3 + rule14_x3 ==  locCMT_y3 - locCMT_x3)
s.add(0 + rule3_x3 + rule4_x3 - rule11_x3 - rule15_x3 + rule15_x3 ==  locABR_y3 - locABR_x3)
s.add(0 + rule6_x3 + rule7_x3 + rule8_x3 + rule9_x3 + rule10_x3 + rule11_x3 ==  locCR_y3 - locCR_x3)
...
s.add(Implies( (rule3_x3 > 0), And(nsntNoCF_x3>=1, ) ))
...
s.add(locSE_x4 >= 0)
s.add(locSE_y4 >= 0)
locFDSE_x4 = Real('locFDSE_x4')
locFDSE_y4 = Real('locFDSE_y4')
s.add(locFDSE_x4 >= 0)
s.add(locFDSE_y4 >= 0)
...
s.add(0 - rule1_x4 - rule7_x4 ==  locYES_y4 - locYES_x4)
s.add(0 + rule0_x4 + rule1_x4 - rule2_x4 - rule3_x4 - rule5_x4 - rule8_x4 - rule12_x4 + rule12_x4 ==  locSE_y4 - locSE_x4)
s.add(0 + rule2_x4 - rule4_x4 - rule9_x4 - rule13_x4 + rule13_x4 ==  locFDSE_y4 - locFDSE_x4)
s.add(0 + rule5_x4 - rule10_x4 - rule14_x4 + rule14_x4 ==  locCMT_y4 - locCMT_x4)
s.add(0 + rule3_x4 + rule4_x4 - rule11_x4 - rule15_x4 + rule15_x4 ==  locABR_y4 - locABR_x4)
s.add(0 + rule6_x4 + rule7_x4 + rule8_x4 + rule9_x4 + rule10_x4 + rule11_x4 ==  locCR_y4 - locCR_x4)
...
s.add(Implies( (rule3_x4 > 0), And(nsntNoCF_x4>=1, ) ))
...
s.add(0 - rule1_y0 - rule7_y0 ==  locYES_x1 - locYES_y0)
s.add(0 + rule0_y0 + rule1_y0 - rule2_y0 - rule3_y0 - rule5_y0 - rule8_y0 - rule12_y0 + rule12_y0 ==  locSE_x1 - locSE_y0)
s.add(0 + rule2_y0 - rule4_y0 - rule9_y0 - rule13_y0 + rule13_y0 ==  locFDSE_x1 - locFDSE_y0)
s.add(0 + rule5_y0 - rule10_y0 - rule14_y0 + rule14_y0 ==  locCMT_x1 - locCMT_y0)
s.add(0 + rule3_y0 + rule4_y0 - rule11_y0 - rule15_y0 + rule15_y0 ==  locABR_x1 - locABR_y0)
s.add(0 + rule6_y0 + rule7_y0 + rule8_y0 + rule9_y0 + rule10_y0 + rule11_y0 ==  locCR_x1 - locCR_y0)
...
s.add(Implies( (rule3_y0 > 0), And(nsntNoCF_y0>=1, ) ))
...
s.add(0 - rule1_y1 - rule7_y1 ==  locYES_x2 - locYES_y1)
s.add(0 + rule0_y1 + rule1_y1 - rule2_y1 - rule3_y1 - rule5_y1 - rule8_y1 - rule12_y1 + rule12_y1 ==  locSE_x2 - locSE_y1)
s.add(0 + rule2_y1 - rule4_y1 - rule9_y1 - rule13_y1 + rule13_y1 ==  locFDSE_x2 - locFDSE_y1)
s.add(0 + rule5_y1 - rule10_y1 - rule14_y1 + rule14_y1 ==  locCMT_x2 - locCMT_y1)
s.add(0 + rule3_y1 + rule4_y1 - rule11_y1 - rule15_y1 + rule15_y1 ==  locABR_x2 - locABR_y1)
s.add(0 + rule6_y1 + rule7_y1 + rule8_y1 + rule9_y1 + rule10_y1 + rule11_y1 ==  locCR_x2 - locCR_y1)
...
s.add(Implies( (rule3_y1 > 0), And(nsntNoCF_y1>=1, ) ))
...
s.add(0 - rule1_y2 - rule7_y2 ==  locYES_x3 - locYES_y2)
s.add(0 + rule0_y2 + rule1_y2 - rule2_y2 - rule3_y2 - rule5_y2 - rule8_y2 - rule12_y2 + rule12_y2 ==  locSE_x3 - locSE_y2)
s.add(0 + rule2_y2 - rule4_y2 - rule9_y2 - rule13_y2 + rule13_y2 ==  locFDSE_x3 - locFDSE_y2)
s.add(0 + rule5_y2 - rule10_y2 - rule14_y2 + rule14_y2 ==  locCMT_x3 - locCMT_y2)
s.add(0 + rule3_y2 + rule4_y2 - rule11_y2 - rule15_y2 + rule15_y2 ==  locABR_x3 - locABR_y2)
s.add(0 + rule6_y2 + rule7_y2 + rule8_y2 + rule9_y2 + rule10_y2 + rule11_y2 ==  locCR_x3 - locCR_y2)
...
s.add(Implies( (rule3_y2 > 0), And(nsntNoCF_y2>=1, ) ))
...
s.add(0 - rule1_y3 - rule7_y3 ==  locYES_x4 - locYES_y3)
s.add(0 + rule0_y3 + rule1_y3 - rule2_y3 - rule3_y3 - rule5_y3 - rule8_y3 - rule12_y3 + rule12_y3 ==  locSE_x4 - locSE_y3)
s.add(0 + rule2_y3 - rule4_y3 - rule9_y3 - rule13_y3 + rule13_y3 ==  locFDSE_x4 - locFDSE_y3)
s.add(0 + rule5_y3 - rule10_y3 - rule14_y3 + rule14_y3 ==  locCMT_x4 - locCMT_y3)
s.add(0 + rule3_y3 + rule4_y3 - rule11_y3 - rule15_y3 + rule15_y3 ==  locABR_x4 - locABR_y3)
s.add(0 + rule6_y3 + rule7_y3 + rule8_y3 + rule9_y3 + rule10_y3 + rule11_y3 ==  locCR_x4 - locCR_y3)
...
s.add(Implies( (rule3_y3 > 0), And(nsntNoCF_y3>=1, ) ))
...
s.add(Or(locCMT_y4 != 0, locCMT_y4 != 0))
