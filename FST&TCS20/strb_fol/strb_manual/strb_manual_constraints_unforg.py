...
s.add(0 - rule1_x0 - rule3_x0 - rule5_x0 + rule5_x0 ==  loc0_y0 - loc0_x0)
s.add(0 - rule0_x0 - rule2_x0 ==  loc1_y0 - loc1_x0)
s.add(0 + rule0_x0 + rule3_x0 - rule4_x0 - rule6_x0 + rule6_x0 ==  locSE_y0 - locSE_x0)
s.add(0 + rule1_x0 + rule2_x0 + rule4_x0 - rule7_x0 + rule7_x0 ==  locAC_y0 - locAC_x0)
...
s.add(0 + rule0_x0 + rule1_x0 + rule2_x0 + rule3_x0 == nsnt_y0 - nsnt_x0)
...
s.add(Implies( (rule1_x0 > 0), And(nsnt_x0>=N-T-F, ) ))
s.add(Implies( (rule2_x0 > 0), And(nsnt_x0>=N-T-F, ) ))
s.add(Implies( (rule3_x0 > 0), And(nsnt_x0>=T+1-F, ) ))
s.add(Implies( (rule4_x0 > 0), And(nsnt_x0>=N-T-F, ) ))
...
s.add((True) == (True))
s.add((nsnt_x0>=T+1-F) == (nsnt_y0>=T+1-F))
s.add((nsnt_x0>=N-T-F) == (nsnt_y0>=N-T-F))
...
s.add(0 - rule1_x1 - rule3_x1 - rule5_x1 + rule5_x1 ==  loc0_y1 - loc0_x1)
s.add(0 - rule0_x1 - rule2_x1 ==  loc1_y1 - loc1_x1)
s.add(0 + rule0_x1 + rule3_x1 - rule4_x1 - rule6_x1 + rule6_x1 ==  locSE_y1 - locSE_x1)
s.add(0 + rule1_x1 + rule2_x1 + rule4_x1 - rule7_x1 + rule7_x1 ==  locAC_y1 - locAC_x1)
...
s.add(0 + rule0_x1 + rule1_x1 + rule2_x1 + rule3_x1 == nsnt_y1 - nsnt_x1)
...
s.add(Implies( (rule1_x1 > 0), And(nsnt_x1>=N-T-F, ) ))
s.add(Implies( (rule2_x1 > 0), And(nsnt_x1>=N-T-F, ) ))
s.add(Implies( (rule3_x1 > 0), And(nsnt_x1>=T+1-F, ) ))
s.add(Implies( (rule4_x1 > 0), And(nsnt_x1>=N-T-F, ) ))
...
s.add((True) == (True))
s.add((nsnt_x1>=T+1-F) == (nsnt_y1>=T+1-F))
s.add((nsnt_x1>=N-T-F) == (nsnt_y1>=N-T-F))
...
s.add(0 - rule1_x2 - rule3_x2 - rule5_x2 + rule5_x2 ==  loc0_y2 - loc0_x2)
s.add(0 - rule0_x2 - rule2_x2 ==  loc1_y2 - loc1_x2)
s.add(0 + rule0_x2 + rule3_x2 - rule4_x2 - rule6_x2 + rule6_x2 ==  locSE_y2 - locSE_x2)
s.add(0 + rule1_x2 + rule2_x2 + rule4_x2 - rule7_x2 + rule7_x2 ==  locAC_y2 - locAC_x2)
...
s.add(0 + rule0_x2 + rule1_x2 + rule2_x2 + rule3_x2 == nsnt_y2 - nsnt_x2)
...
s.add(Implies( (rule1_x2 > 0), And(nsnt_x2>=N-T-F, ) ))
s.add(Implies( (rule2_x2 > 0), And(nsnt_x2>=N-T-F, ) ))
s.add(Implies( (rule3_x2 > 0), And(nsnt_x2>=T+1-F, ) ))
s.add(Implies( (rule4_x2 > 0), And(nsnt_x2>=N-T-F, ) ))
...
s.add((True) == (True))
s.add((nsnt_x2>=T+1-F) == (nsnt_y2>=T+1-F))
s.add((nsnt_x2>=N-T-F) == (nsnt_y2>=N-T-F))
...
s.add(0 - rule1_x3 - rule3_x3 - rule5_x3 + rule5_x3 ==  loc0_y3 - loc0_x3)
s.add(0 - rule0_x3 - rule2_x3 ==  loc1_y3 - loc1_x3)
s.add(0 + rule0_x3 + rule3_x3 - rule4_x3 - rule6_x3 + rule6_x3 ==  locSE_y3 - locSE_x3)
s.add(0 + rule1_x3 + rule2_x3 + rule4_x3 - rule7_x3 + rule7_x3 ==  locAC_y3 - locAC_x3)
...
s.add(0 + rule0_x3 + rule1_x3 + rule2_x3 + rule3_x3 == nsnt_y3 - nsnt_x3)
...
s.add(Implies( (rule1_x3 > 0), And(nsnt_x3>=N-T-F, ) ))
s.add(Implies( (rule2_x3 > 0), And(nsnt_x3>=N-T-F, ) ))
s.add(Implies( (rule3_x3 > 0), And(nsnt_x3>=T+1-F, ) ))
s.add(Implies( (rule4_x3 > 0), And(nsnt_x3>=N-T-F, ) ))
...
s.add((True) == (True))
s.add((nsnt_x3>=T+1-F) == (nsnt_y3>=T+1-F))
s.add((nsnt_x3>=N-T-F) == (nsnt_y3>=N-T-F))
...
s.add(0 - rule1_y0 - rule3_y0 - rule5_y0 + rule5_y0 ==  loc0_x1 - loc0_y0)
s.add(0 - rule0_y0 - rule2_y0 ==  loc1_x1 - loc1_y0)
s.add(0 + rule0_y0 + rule3_y0 - rule4_y0 - rule6_y0 + rule6_y0 ==  locSE_x1 - locSE_y0)
s.add(0 + rule1_y0 + rule2_y0 + rule4_y0 - rule7_y0 + rule7_y0 ==  locAC_x1 - locAC_y0)
...
s.add(0 + rule0_y0 + rule1_y0 + rule2_y0 + rule3_y0 == nsnt_x1 - nsnt_y0)
...
s.add(Implies( (rule1_y0 > 0), And(nsnt_y0>=N-T-F, ) ))
s.add(Implies( (rule2_y0 > 0), And(nsnt_y0>=N-T-F, ) ))
s.add(Implies( (rule3_y0 > 0), And(nsnt_y0>=T+1-F, ) ))
s.add(Implies( (rule4_y0 > 0), And(nsnt_y0>=N-T-F, ) ))
...
s.add(0 - rule1_y1 - rule3_y1 - rule5_y1 + rule5_y1 ==  loc0_x2 - loc0_y1)
s.add(0 - rule0_y1 - rule2_y1 ==  loc1_x2 - loc1_y1)
s.add(0 + rule0_y1 + rule3_y1 - rule4_y1 - rule6_y1 + rule6_y1 ==  locSE_x2 - locSE_y1)
s.add(0 + rule1_y1 + rule2_y1 + rule4_y1 - rule7_y1 + rule7_y1 ==  locAC_x2 - locAC_y1)
...
s.add(0 + rule0_y1 + rule1_y1 + rule2_y1 + rule3_y1 == nsnt_x2 - nsnt_y1)
...
s.add(Implies( (rule1_y1 > 0), And(nsnt_y1>=N-T-F, ) ))
s.add(Implies( (rule2_y1 > 0), And(nsnt_y1>=N-T-F, ) ))
s.add(Implies( (rule3_y1 > 0), And(nsnt_y1>=T+1-F, ) ))
s.add(Implies( (rule4_y1 > 0), And(nsnt_y1>=N-T-F, ) ))
...
s.add(0 - rule1_y2 - rule3_y2 - rule5_y2 + rule5_y2 ==  loc0_x3 - loc0_y2)
s.add(0 - rule0_y2 - rule2_y2 ==  loc1_x3 - loc1_y2)
s.add(0 + rule0_y2 + rule3_y2 - rule4_y2 - rule6_y2 + rule6_y2 ==  locSE_x3 - locSE_y2)
s.add(0 + rule1_y2 + rule2_y2 + rule4_y2 - rule7_y2 + rule7_y2 ==  locAC_x3 - locAC_y2)
...
s.add(0 + rule0_y2 + rule1_y2 + rule2_y2 + rule3_y2 == nsnt_x3 - nsnt_y2)
...
s.add(Implies( (rule1_y2 > 0), And(nsnt_y2>=N-T-F, ) ))
s.add(Implies( (rule2_y2 > 0), And(nsnt_y2>=N-T-F, ) ))
s.add(Implies( (rule3_y2 > 0), And(nsnt_y2>=T+1-F, ) ))
s.add(Implies( (rule4_y2 > 0), And(nsnt_y2>=N-T-F, ) ))
